  ...
  return (
    <div className="text-white  py-5 px-6">
      <div className=" flex items-center justify-center">
        ...
        <div className="max-w-6xl  mx-auto w-full flex flex-col lg:flex-row-reverse items-center gap-10">
          ...
          <div data-aos="fade-right" className="w-full space-y-4">
            ...
            <button
              onClick={resumeBtn}
              className="btn btn-outline border-[#00ffff] text-white hover:bg-[#00ffff] backdrop-blur-2xl bg-white/5 hover:text-gray-900"
            >
              View Resume
            </button>
          </div>
